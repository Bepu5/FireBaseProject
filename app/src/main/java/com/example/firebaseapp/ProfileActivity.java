...
public class ProfileActivity extends AppCompatActivity {
        ...
        reference.child(userID).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(userProfile != null){
                    ...
                    Glide.with(ProfileActivity.this).load(userProfile.profile_picture).fitCenter().error(R.drawable.prof_settings).placeholder(R.drawable.prof_settings).into(profilePicture);
                }
            }
    ...
    private void updateProfilePicture(String url){
        FirebaseDatabase.getInstance("https://missatgeria-serveis-default-rtdb.europe-west1.firebasedatabase.app/").getReference("Users/" + FirebaseAuth.getInstance().getCurrentUser().getUid() + "/profile_picture").setValue(url);
    }
}