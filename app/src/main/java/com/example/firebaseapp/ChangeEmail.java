...
public class ChangeEmail extends AppCompatActivity {
    ...
    private void resetEmail(EditText email) {
        ...
        if (emailText.isEmpty()) {
            Toast.makeText(ChangeEmail.this, "Email is required", Toast.LENGTH_LONG).show();
            return;
        }
        if (!Patterns.EMAIL_ADDRESS.matcher(emailText).matches()) {
            Toast.makeText(ChangeEmail.this, "Please provide a valid email", Toast.LENGTH_LONG).show();
            return;
        }
        user.updateEmail(emailText).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void unused) {
                ...
                Toast.makeText(ChangeEmail.this, "Email changed succesfuly, verify your email!", Toast.LENGTH_LONG).show();
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(ChangeEmail.this, "Change email failed!", Toast.LENGTH_LONG).show();
            }
        });
